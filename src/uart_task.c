...
-*----------------------------------------------------------------------------*/
void UART2_BUF_O_Write_Number10_To_Buffer(const uint32_t dat)
{
    char Digit[11];
    ...
    Digit[9]  = 48 + (dat % 10);
    Digit[8]  = 48 + ((dat/10) % 10);
    Digit[7]  = 48 + ((dat/100) % 10);
    Digit[6]  = 48 + ((dat/1000) % 10);
    Digit[5]  = 48 + ((dat/10000) % 10);
    Digit[4]  = 48 + ((dat/100000) % 10);
    Digit[3]  = 48 + ((dat/1000000) % 10);
    Digit[2]  = 48 + ((dat/10000000) % 10);
    Digit[1]  = 48 + ((dat/100000000) % 10);
    Digit[0]  = 48 + ((dat/1000000000) % 10);
    int_enable();
...
-*----------------------------------------------------------------------------*/
void UART2_BUF_O_Write_Number03_To_Buffer(const uint32_t dat)
{
    char Digit[4];
    ...
    {    
        ...
        Digit[2] = 48 + (dat % 10);
        Digit[1] = 48 + ((dat/10) % 10);
        Digit[0] = 48 + ((dat/100) % 10);
        int_enable();
...
-*----------------------------------------------------------------------------*/
void UART2_BUF_O_Write_Number02_To_Buffer(const uint32_t dat)
{
    char Digit[3];
